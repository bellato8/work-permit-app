...
exports.removeAdmin = (0, https_1.onRequest)({ region: "asia-southeast1", secrets: [APPROVER_KEY] }, (0, withCors_1.withCors)(async (req, res) => {
    try {
        ...
        const requester = (0, authz_1.getRequesterEmail)(req) || gate.email || undefined;
        ...
        // 6) audit log
        await (0, emitAudit_1.emitAudit)("admin_removed", requester ? { email: requester } : "unknown", { type: "admin", id: uid, rid: email }, softDelete ? "soft delete admin caps" : "delete admin doc", { ip: ipOf(req), ua: uaOf(req) });
